...
function buildColumnMap(headerMap: Map<string, number>): ColumnMap {
  return {
    ...
    registrationStatus: getOptionalColumnIndex(headerMap, 'Registration.RegistrationStatus'),
    ...
    legalAddressLine2: getOptionalColumnIndex(headerMap, 'Entity.LegalAddress.AdditionalAddressLine.1'),
    ...
    hqAddressLine2: getOptionalColumnIndex(headerMap, 'Entity.HeadquartersAddress.AdditionalAddressLine.1'),
